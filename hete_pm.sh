...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $compare_bin $m122 $k150 $tmp; } &>> $ctx/vm1.compare
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $compare_bin -channel red -metric PSNR $m122 $k150 $tmp; } &>> $ctx/vm1.compare.channel_red
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $compare_bin -compose src $m122 $k150 $tmp; } &>> $ctx/vm1.compare.compose
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $convert_bin $m122 -colorspace Gray  -edge 1 -negate $tmp; } &>> $ctx/vm1.convert.edge_detect
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $convert_bin $m122 -blur 0x8 $tmp; } &>> $ctx/vm1.convert.blur
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $convert_bin $m122 -charcoal 3 $tmp; } &>> $ctx/vm1.convert.charcoal
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $convert_bin -size 15360x8640 gradient:green-yellow $tmp; } &>> $ctx/vm1.convert.draw
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $convert_bin $m122 -morphology CloseI Disk:2.5 $tmp; } &>> $ctx/vm1.convert.paint_effect
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $convert_bin $m122 -sharpen 0x1 $tmp; } &>> $ctx/vm1.convert.sharpen
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $convert_bin $m122 -fft +depth +adjoin $tmp; } &>> $ctx/vm1.convert.fft
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $convert_bin $m122 -background Blue  -shear 20x0 $tmp; } &>> $ctx/vm1.convert.shear
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $mogrify_bin -resize 50% $m122; } &>> $ctx/vm1.mogrify.resize
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 $mogrify_bin -segment 128000x60 $m78; } &>> $ctx/vm1.mogrify.segment
